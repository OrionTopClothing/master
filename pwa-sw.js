const CACHE_VERSION = '1.7.14';

const BASE_CACHE_FILES = [
    'https://oriontop.xyz/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://oriontop.xyz/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
...
const OFFLINE_PAGE = 'https://oriontop.xyz/';
const NOT_FOUND_PAGE = 'https://oriontop.xyz/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://oriontop.xyz//wp-admin/');
//    },
];
