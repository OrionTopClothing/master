					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<span class="description"><?php echo esc_html__( 'Before you can start using Apple for the social login, you need to create a Apple Application. You can get a step by step tutorial on how to create Apple Application on our', 'wooslg' ) . ' <a target="_blank" href="https://docs.wpwebelite.com/social-network-integration/apple/">'. esc_html__( 'Documentation', 'wooslg' ). '</a>'; ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<input id="woo_slg_apple_client_id" type="text" class="regular-text" name="woo_slg_apple_client_id" value="<?php echo $woo_slg_model->woo_slg_escape_attr( $woo_slg_apple_client_id ); ?>" /></br>
									<span class="description"><?php echo esc_html__( 'Enter Apple Client ID.', 'wooslg'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'If you want to use your own Apple Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<input type="button" class="woo-slg-upload-file-button button-secondary" value="<?php esc_html_e( 'Upload File', 'wooslg' );?>"/></br>
									<span class="description"><?php echo esc_html__( 'If you want to use your own Apple Link Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
