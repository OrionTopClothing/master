                        ...
                        <tbody>
                            ...
                            <tr class="show_hide<?php echo ($woo_slg_enable_email_varification == 'yes') ? ' woo_slg_mail_settings_show_rows' : ' woo_slg_mail_settings_hide_rows'; ?>">
                                ...
                                <td>
                                    ...
                                    <span class="description" id="email_description_for_body"><?php echo sprintf(esc_html__('%s Enter the content for email body. %s {verify_link} %s - This tag used to create verify link. %s', 'wooslg'), '<desc>', '<br/><code>', '</code>', '</desc>'); ?></span>
                                </td>
                            </tr>
                            ...
                            <tr class="show_otp_hide<?php echo ($woo_slg_enable_email_otp_varification == 'yes' && $woo_slg_enable_email_varification == 'yes') ? ' woo_slg_mail_otp_settings_show_rows' : '  woo_slg_mail_otp_settings_hide_rows'; ?>">
                                ...
                                <td>
                                    <input id="woo_slg_mail_otp_subject" type="text" class="regular-text" name="woo_slg_mail_otp_subject" value="<?php echo $woo_slg_model->woo_slg_escape_attr($woo_slg_mail_otp_subject); ?>" placeholder="Activate your Account" /></br>
                                    <span class="description"><?php echo sprintf(esc_html__('%s Enter the OTP email subject. %s {otp} %s - This tag used to generate OTP verify. %s {site_title} %s- This tag used for display site title. %s', 'wooslg'), '<desc>', '<br/><code>', '</code>','<br /><code>','</code>', '</desc>'); ?></span>
                                </td>
                            </tr>
                            ...
                            <tr class="show_otp_hide<?php echo ($woo_slg_enable_email_otp_varification == 'yes' && $woo_slg_enable_email_varification == 'yes') ? ' woo_slg_mail_otp_settings_show_rows' : ' woo_slg_mail_otp_settings_hide_rows'; ?>">
                                ...
                                <td>
                                    <?php
                                    $editor_id = 'woo_slg_mail_otp_content';
                                    wp_editor($woo_slg_mail_otp_content, $editor_id);
                                    ?>
                                    
                                    </br>
                                    <span class="description" id="email_description_for_body_otp"><?php echo sprintf(esc_html__('%s Enter the content for OTP email body. %s {otp} %s - This tag used to generate OTP verify. %s {site_title} %s- This tag used for display site title. %s', 'wooslg'), '<desc>', '<br/><code>', '</code>','<br /><code>','</code>', '</desc>'); ?></span>
                                </td>
                            </tr>
