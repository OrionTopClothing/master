					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								...
								<td>
									<span class="description"><?php echo esc_html__( 'Before you can start using Line for the social login, you need to create a Line Channel. You can get a step by step tutorial on how to create Line Channel on our', 'wooslg' ) . ' <a target="_blank" href="https://docs.wpwebelite.com/social-network-integration/line/">'. esc_html__( 'Documentation', 'wooslg' ). '</a>'; ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<input id="woo_slg_line_client_id" type="text" class="regular-text" name="woo_slg_line_client_id" value="<?php echo $woo_slg_model->woo_slg_escape_attr( $woo_slg_line_client_id ); ?>" /></br>
									<span class="description"><?php echo esc_html__( 'Enter Line Channel ID.', 'wooslg'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<input id="woo_slg_line_client_secret" type="text" class="regular-text" name="woo_slg_line_client_secret" value="<?php echo $woo_slg_model->woo_slg_escape_attr( $woo_slg_line_client_secret ); ?>" /></br>
									<span class="description"><?php echo esc_html__( 'Enter Line Channel Secret.', 'wooslg'); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<span class="description"><?php echo esc_html__( 'If you want to use your own Line Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									...
									<input type="button" class="woo-slg-upload-file-button button-secondary" value="<?php esc_html_e( 'Upload File', 'wooslg' );?>"/></br>
									<span class="description"><?php echo esc_html__( 'If you want to use your own Line Link Icon, upload one here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<input id="woo_slg_line_icon_text" type="text" class="regular-text woo_slg_social_btn_text" name="woo_slg_line_icon_text" value="<?php echo $woo_slg_model->woo_slg_escape_attr( $woo_slg_line_icon_text ); ?>" /></br>
									<span class="description"><?php echo esc_html__( 'If you want to use your own Line Text, Enter here.', 'wooslg' ); ?></span>
								</td>
							</tr>
							...
							<tr valign="top">
								...
								<td>
									<input id="woo_slg_line_link_icon_text" type="text" class="regular-text woo_slg_social_btn_text" name="woo_slg_line_link_icon_text" value="<?php echo $woo_slg_model->woo_slg_escape_attr( $woo_slg_line_link_icon_text ); ?>" /></br>
									<span class="description"><?php echo esc_html__( 'If you want to use your own Line Link Text, enter here.', 'wooslg' ); ?></span>
								</td>
							</tr>
