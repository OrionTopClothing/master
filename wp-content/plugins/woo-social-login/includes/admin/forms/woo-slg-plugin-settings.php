...
<div class="wrap">
	...
	<form action="<?php echo $woo_social_settings_page_url; ?>" method="post">
		...
		$general_tab = $facebook_tab = $google_plus_tab = $linkedin_tab = $twitter_tab = $yahoo_tab = $foursquare_tab = $windows_live_tab = $vk_tab = $instagram_tab = $amazon_tab = $paypal_tab = $misc_tab = $email_login_tab = $apple_login_tab = $line_tab = '';
		$general_content = $facebook_content = $google_plus_content = $linkedin_content = $twitter_content = $yahoo_content = $foursquare_content = $windows_live_content = $vk_content = $instagram_content = $amazon_content = $paypal_content = $line_content = $misc_content = $apple_login_content = $email_login_content = '';
