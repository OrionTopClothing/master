    ...
    public function woo_slg_get_user_common_social_data($social_data = array(), $social_type = '')
    {
        ...
        if (!empty($social_type)) { // If social type is not empty
            switch ($social_type) {
                ...
                case 'yahoo':
                $common_social_data['first_name'] = isset( $social_data['givenName'] ) ? $social_data['givenName'] : '';
                $common_social_data['last_name'] = isset( $social_data['familyName'] ) ? $social_data['familyName'] : '';
                $common_social_data['name'] = $common_social_data['first_name'].' '.$common_social_data['last_name'];
                $common_social_data['email'] = !empty( $social_data['emails'] ) ? $social_data['emails'][0]['handle'] : '';
                $common_social_data['type'] = $social_type;
                $common_social_data['all'] = $social_data;
                $common_social_data['link'] = isset( $social_data['profileUrl'] ) ? $social_data['profileUrl'] : '';
                $common_social_data['id'] = isset( $social_data['guid'] ) ? $social_data['guid'] : '';
                break;
                ...
                $common_social_data['type'] = $social_type;
                $common_social_data['all'] = $social_data;
                $common_social_data['link'] = isset( $social_data->id ) ? 'https://foursquare.com/user/' . $social_data->id : '';
                $common_social_data['id'] = isset( $social_data->id ) ? $social_data->id : '';
                break;
                ...
                $common_social_data['first_name'] = isset( $social_data->first_name ) ? $social_data->first_name : '';
                $common_social_data['last_name'] = isset( $social_data->last_name ) ? $social_data->last_name : '';
                $common_social_data['name'] = isset( $social_data->username ) ? $social_data->username : '';
                $common_social_data['email'] = '';
                $common_social_data['type'] = $social_type;
                $common_social_data['all'] = $social_data;
                $common_social_data['link'] = isset( $social_data->profile_picture ) ? $social_data->profile_picture : '';
                $common_social_data['id'] = isset( $social_data->id ) ? $social_data->id : '';
                break;
                ...
                $common_social_data['last_name'] = '';
                    ...
                    $common_social_data['all'] = $social_data;
                    $common_social_data['link'] = isset( $social_data->screen_name ) ? 'https://twitter.com/' . $social_data->screen_name : '';
                    $common_social_data['id'] = isset( $social_data->id ) ? $social_data->id : '';
