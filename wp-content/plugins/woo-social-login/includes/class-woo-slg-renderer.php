...
class WOO_Slg_Renderer {
	...
	public $socialfoursquare, $socialyahoo, $socialwindowslive, $socialvk, $socialinstagram, $socialamazon, $socialpaypal, $socialline, $sociallinelive,$socialapple;
		...
		if(!empty($woo_slg_options) && $woo_slg_options['woo_slg_display_link_peepso_acc_detail'] == 'yes'){
			$custom_settings = array(
				'wb_custom_notification_setting' => array(
					'title' => '',
					'items' =>$this->woo_slg_social_profile()
				),
			);
		}else{
			$custom_settings = array();
	...
	public function woo_slg_login_apple() {
		...
		if( $woo_slg_options['woo_slg_enable_apple'] == "yes" ) {
			...
			if( WOO_SLG_APPLE_CLIENT_ID != '') {
				...
				echo '<input type="hidden" class="woo-slg-social-apple-redirect-url" id="woo_slg_social_apple_redirect_url" name="woo_slg_social_apple_redirect_url" value="'.$apple_authurl.'"/>';
			}
		}
	}
	 ...
	 * 
	 * Handles to show linelive social login
	 * button
	 * 
	 * @package WooCommerce - Social Login
	 * @since 1.9.14
	...
	public function woo_slg_login_line() {
		...
		if( $woo_slg_options['woo_slg_enable_line'] == "yes" ) {
			...
			if( WOO_SLG_LINE_CLIENT_ID != '' && WOO_SLG_LINE_CLIENT_SECRET != '' ) {
				...
				echo '<input type="hidden" class="woo-slg-social-line-redirect-url" id="woo_slg_social_line_redirect_url" name="woo_slg_social_line_redirect_url" value="'.$line_authurl.'"/>';
			}
		}
	}
