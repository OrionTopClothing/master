...
jQuery(document).ready(function ($) {
    ...
    //$("#email_description_for_body_otp").hide();
    ...
    $("#woo_slg_enable_email_varification").on("change", function () {
        if ($(this).is(":checked")) {
            ...
            $( "#woo_slg_enable_email_otp_varification" ).prop( "checked", false );
            $(".show_hide").hide();
            $(".show_otp_hide").hide();
        }
    });

    $("#woo_slg_enable_email_otp_varification").on("change", function () {
        if ($(this).is(":checked")) {
            $(".show_otp_hide").show();
        } else {
            $(".show_otp_hide").hide();
    ...
    $('input[type=radio][name=woo_slg_enable_email_varification_using]').change(function() {
        if (this.value == '2') {
            $("#email_description_for_body_otp").show();
