	...
	class WOO_Slg_Social_Apple {
    	...
    	public function woo_slg_get_apple_login_url() {
    		...
    		if( !empty( $woo_slg_options['woo_slg_enable_apple'] ) && !empty( $woo_slg_options['woo_slg_apple_client_id'] ) ) {
    			...
    			$url = "https://appleid.apple.com/auth/authorize?client_id=".$client_id."&redirect_uri=".$redirecturl."&response_type=".$response_type."&state=".$state."&scope=".$scope."&response_mode=form_post";
    			return $url;
    		}
    	}
