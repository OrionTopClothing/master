...
function woo_slg_initialize() {
    ...
    if (!defined('WOO_SLG_LINE_REDIRECT_URL')) {
        $lineurl = site_url('/');//add_query_arg('wooslg', 'line', site_url('/'));
...
function woo_slg_check_social_enable() {
    ...
    if (( $woo_slg_options['woo_slg_enable_facebook'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_googleplus'] == "yes" ) ||
            ...
            ( $woo_slg_options['woo_slg_enable_vk'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_instagram'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_amazon'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_paypal'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_email'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_line'] == "yes" ) || ( $woo_slg_options['woo_slg_enable_apple'] == "yes" ) ) {
...
function woo_slg_add_no_cache_param( $url ) {
    ...
    if( isset( $woo_slg_options['woo_slg_public_js_unique_version'] ) && !empty( $woo_slg_options['woo_slg_public_js_unique_version'] ) && $woo_slg_options['woo_slg_public_js_unique_version'] == 'yes' && !empty( $url) ){
