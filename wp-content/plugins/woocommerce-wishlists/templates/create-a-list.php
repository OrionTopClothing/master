        ...
        <div class="wl-form">
            <form action="" enctype="multipart/form-data" method="post">
                ...
                <p class="form-row form-row-wide">
                    ...
                    <input type="text" name="wishlist_title" id="wishlist_title" class="input-text" value="<?php esc_attr_e( $args['wishlist_title'] ); ?>"/>
                </p>
                <p class="form-row form-row-wide">
                ...
                <p class="form-row form-row-first">
					...
					<?php if ( is_user_logged_in() ) : ?>
                        <input type="text" name="wishlist_first_name" id="wishlist_first_name" class="input-text" value="<?php echo empty( $args['wishlist_first_name'] ) ? esc_attr( $current_user->user_firstname ) : esc_attr( $args['wishlist_first_name'] ); ?>"/>
					<?php else : ?>
                        <input type="text" name="wishlist_first_name" id="wishlist_first_name" class="input-text" value="<?php echo esc_attr_e( $args['wishlist_first_name'] ); ?>"/>
					<?php endif; ?>
                </p>
                <p class="form-row form-row-last">
                    <label for="wishlist_first_name"><?php _e( 'Last Name', 'wc_wishlist' ); ?><?php do_action( 'woocommerce_wishlist_after_last_name_field_label' ); ?></label>

					<?php if ( is_user_logged_in() ) : ?>
                        <input type="text" name="wishlist_last_name" id="wishlist_last_name" class="input-text" value="<?php echo empty( $args['wishlist_last_name'] ) ? esc_attr( $current_user->user_lastname ) : esc_attr( $args['wishlist_last_name'] ); ?>"/>

					<?php else : ?>
                        <input type="text" name="wishlist_last_name" id="wishlist_last_name" class="input-text" value="<?php echo esc_attr_e( $args['wishlist_last_name'] ); ?>"/>
					<?php endif; ?>
                </p>
                <p class="form-row form-row-first">
                    ...
                    <input type="text" name="wishlist_owner_email" id="wishlist_owner_email" value="<?php echo( is_user_logged_in() ? $current_user->user_email : esc_attr( $args['wishlist_owner_email'] ) ); ?>" class="input-text"/>
                </p>
