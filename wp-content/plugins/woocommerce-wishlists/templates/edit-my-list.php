        ...
        <div class="wl-intro">
            ...
            <p>
				...
				<?php if ( ( $sharing == 'Public' || $sharing == 'Shared' ) && count( $wishlist_items ) ) : ?>
                    |
                    <a rel="nofollow" href="<?php $wishlist->the_url_view(); ?>&preview=true"><?php _e( 'Preview List', 'wc_wishlist' ); ?></a>
				<?php endif; ?>
            </p>
        </div>
								...
								if ( $_product->exists() && $item['quantity'] > 0 ) {
                                    ...
                                    <tr class="cart_table_item">
                                        ...
                                        <td class="product-remove">
                                            <a rel="nofollow" href="<?php echo woocommerce_wishlist_url_item_remove( $wishlist->id, $wishlist_item_key ); ?>" class="remove wlconfirm" title="<?php _e( 'Remove this item from your wishlist', 'wc_wishlist' ); ?>" data-message="<?php esc_attr( _e( 'Are you sure you would like to remove this item from your list?', 'wc_wishlist' ) ); ?>">&times;</a>
                                        </td>
                                        ...
                                        <td class="product-purchase">
											<?php if ( apply_filters( 'woocommerce_wishlist_user_can_purcahse', true, $_product ) ): ?>
												<?php if ( $_product->get_type() != 'external' && $_product->is_in_stock() ) : ?>
                                                    <a rel="nofollow" href="<?php echo woocommerce_wishlist_url_item_add_to_cart( $wishlist->id, $wishlist_item_key, $wishlist->get_wishlist_sharing() == 'Shared' ? $wishlist->get_wishlist_sharing_key() : false, 'edit' ); ?>" class="wishlist-add-to-cart-button button alt"><?php _e( 'Add to Cart', 'wc_wishlist' ); ?></a>
												<?php elseif ( $_product->get_type() == 'external' ) : ?>
                                                    <a rel="nofollow" href="<?php echo esc_url( $_product->add_to_cart_url() ); ?>" rel="nofollow" class="single_add_to_cart_button button alt"><?php echo esc_html( $_product->single_add_to_cart_text() ); ?></a>
												<?php endif; ?>
											<?php endif; ?>
                                        </td>
                                    </tr>
