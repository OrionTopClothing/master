...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'      => array(
			array(
				'element'     => '.header-4 .col-full.main-header',
				'property'    => 'height',
				'units'       => 'px',
				'media_query' => '@media (min-width: 993px)',
			),
			array(
				'element'     => '.header-4 .menu-primary-menu-container > ul > li > a',
...
// Sticky Header Height - Only for header-4 layout.
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		'type'        => 'slider',
		'settings'    => 'shoptimizer_sticky_header_height',
		'label'       => esc_html__( 'Sticky Header Height', 'shoptimizer' ),
		'description' => esc_html__( 'Adjust the sticky header height', 'shoptimizer' ),
		'section'     => 'shoptimizer_header_section_layout',
		'default'     => 75,
		'priority'    => 1,
		'active_callback'  => [
			...
			[
				'setting'  => 'shoptimizer_sticky_header',
				'operator' => '==',
				'value'    => 'enable',
			],
		],		
		...
		'output'      => array(
			array(
				'element'     => '.header-4 .col-full.main-header.is_stuck',
				'property'    => 'height',
				'units'       => 'px',
				'media_query' => '@media (min-width: 993px)',
			),
			array(
				'element'     => '.header-4 .is_stuck .menu-primary-menu-container > ul > li > a',
				'property'    => 'line-height',
				'units'       => 'px',
				'media_query' => '@media (min-width: 993px)',
			),
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'    => array(
			array(
				'element'     => '.header-4 .menu-primary-menu-container > ul > li > a, .header-4 .site-header-cart .cart-contents .amount',
				'property'    => 'color',
				'media_query' => '@media (min-width: 993px)',
			),
		),
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'    => array(
			...
			array(
				'element'  => '.site-header .site-header-cart a.cart-contents .count, .shoptimizer-cart-icon i',
				'property' => 'color',
			),
			array(
...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'output'    => array(
			array(
				'element'  => '.site-header .site-header-cart a.cart-contents:hover .count',
				'property' => 'color',
				'media_query' => '@media (min-width: 993px)',
			),
		),
