...
?>
	...
	<div class="p-related mgt60 mgb30">
		...
		<div class="products grid <?php if ( count( $related_products ) > $limit || wp_is_mobile() && count( $related_products ) > 1 ) echo 'wr-nitro-carousel '; if ( wp_is_mobile() ) echo 'mobile-layout mobile-grid mobile-grid-layout'; ?>" data-owl-options='{"items": "<?php echo ( int ) $limit; ?>", "dots": "true", "tablet":"3","mobile":"2"<?php echo ( $wr_nitro_options['rtl'] ? ',"rtl": "true"' : '' ); ?>}'>
			<?php
